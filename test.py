...
trainA_dir = '/home/xuagu37/CycleGAN/data/dwi_subject_1_100_slice_66_volume_1_10.nii.gz'
trainB_dir = '/home/xuagu37/CycleGAN/data/FA_subject_1_100_slice_66_times_10.nii.gz'
models_dir = '/home/xuagu37/CycleGAN/models'
batch_size = 1
epochs = 200
output_sample_flag = True
output_sample_dir = '/home/xuagu37/CycleGAN/output_sample.png'
normalization_factor_A = 4000
normalization_factor_B = 1
cycle_loss_type = 'L1'
use_resize_convolution=True

myCycleGAN = CycleGAN()
myCycleGAN.train(trainA_dir, normalization_factor_A, trainB_dir, normalization_factor_B, models_dir, batch_size, epochs, cycle_loss_type, use_resize_convolution, output_sample_flag, output_sample_dir)
